...
public class BusinessStoriesPresenterTest {
    ...
    private BusinessStoriesPresenter presenter;
    ...
    public void storiesLoaded() throws Exception {
        ...
        verify(newsRequester).getBusinessStories();
    ...
    private void initializePresenter() {
        presenter = new BusinessStoriesPresenter(viewModel, newsRequester);
    }
    ...
    private List<Story> setUpSuccess() {
        ...
        when(newsRequester.getBusinessStories()).thenReturn(Single.just(storyList));
        return storyList;
    }

    private Throwable setUpError() {
        Throwable error = new IOException();
        when(newsRequester.getBusinessStories()).thenReturn(Single.error(error));
        return error;
    }
