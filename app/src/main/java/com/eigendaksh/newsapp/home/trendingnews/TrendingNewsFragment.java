 ...
 */
public class TrendingNewsFragment extends BaseFragment {
    ...
    private TrendingNewsViewModel viewModel;
    ...
    public static TrendingNewsFragment newInstance() {
        return new TrendingNewsFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(TrendingNewsViewModel.class);
        ...
        newsList.setAdapter(new PopularStoriesAdapter(viewModel, this));
        observeViewModel();
